"""
Django settings for manheim_marketinsig_45905 project.
...
ROOT_URLCONF = 'manheim_marketinsig_45905.urls'
...
WSGI_APPLICATION = 'manheim_marketinsig_45905.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manheim_marketinsig_45905 API",
    "DESCRIPTION": "API documentation for manheim_marketinsig_45905 App",
    "VERSION": "v1",
}
